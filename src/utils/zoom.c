...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/08 23:44:41 by fmesa-or          #+#    #+#             */
/*   Updated: 2024/05/14 13:40:48 by fmesa-or         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
***********************************************/
static void	update_range(t_cords *range, double center, double factor)
{
	double	width;
	double	new_width;
...
void	zoom(t_data *data)
{
	...
	data->zoom.y = data->y.min + (data->y.max - data->y.min) * (data->mouse.x
